...
export const registerCompany = async (req, res) => {
    try {
        const {name} = req.body;   //ye variable hoga for company  name
        if (!name) {
        ...
        // })
         ...
         company = new Company({ name : name , userId : userID });
        await company.save();
        //ab create hochuka 
...
export const updateCompany = async (req, res) => {
    try {
        ...
        const updateData = {name, description, website, location , logo : cloudResponse.secure_url}; //ekk sath dal denge y pura

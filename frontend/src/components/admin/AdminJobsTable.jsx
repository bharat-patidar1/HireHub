                                        ...
                                        <TableCell className="text-right cursor-pointer">
                                            <Popover>
                                                ...
                                                <PopoverContent className="w-32">
                                                    <div onClick={()=>navigate(`/admin/companies/}`)} className="flex items-center gap-2 w-fit cursor-pointer">
                                                        <Edit2 className="w-4 " />
                                                        <span>Edit</span>
                                                    </div>
                                                    <div onClick={()=>navigate(`${job._id}/applicants`)} className="flex items-center w-fit gap-2 cursor-pointer mt-2">
                                                        <Eye className="w-4"/>
